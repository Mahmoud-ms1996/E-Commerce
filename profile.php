...
?>                             
<h1 class="text-center"><?php echo $sessionUser ?> Profile</h1> <!-- $sessionUser from init.php -->                        
            ...
            <div class="panel-body">
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <span>Favourite Category</span> : <?php echo 'Not Yet' ?>
                    </li>
                </ul>
                <a href="#" class="btn btn-primary" style="float:right;">Edit Information</a>
            </div>
        </div>    
    </div>
</div>
