<?php 
    ...
    if(isset($_SESSION['Username'])){
        ...
        $LatestUsers = getlatest("*", "users", "UserID", $numUsers); // num Users Array

        $numItems = 3; // Number of Latest Items
        $latestItems = getlatest("*","items","item_ID",$numItems); // num Users Array

        $numComments = 2; // Number of Latest Comments
        $latestComments = getlatest("*","comments","c_id",$numComments); // num Comments Array
