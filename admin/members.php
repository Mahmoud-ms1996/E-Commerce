            ...
            <h1 class="text-center">Manage Member</h1>
                <div class="container">
                    <div class="table-responsive">
                        <table class="main imgmembers text-center table table-bordered" style="box-shadow:0 3px 10px #CCC">
                            <tr >
                                <td>#ID</td>
                                <td>Avatar</td>
                                <td>Username</td>
                            ...
                            <?php 
                                foreach($rows as $row){
                                    echo"<tr>";
                                        ...
                                        echo "<td>";
                                        if (empty($row['avatar'])){
                                            echo "<img src='uploads/avatars/user_img1.png' alt='' style='width:50px;height: 50px;'/>";
                                        } else{
                                        echo "<img src='uploads/avatars/" . $row['avatar'] . "' alt='' style='width:60px;height: 50px;'/>";
                                        }
                                        echo"</td>";
                ...
                <div class="container">
                    <form class="form-horizontal" action="?do=Insert" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-group-lg">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="username" class="form-control" autocomplete="off" required="required" placeholder="Username To Login Into the Shop"/>
                            </div>
                        </div>
                        <!-- End Username Field -->
                        ...
                        <div class="form-group form-group-lg">
                            ...
                            <div class="col-sm-10">
                                <input type="password" name="password" class="password form-control" required="required" placeholder="Password Must be Hard & Complex"/>
                        ...
                        <div class="form-group form-group-lg">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="full" class="form-control" autocomplete="off" required="required" placeholder="Full Name Must Be Appear In Your Profile Page"/>
                            </div>
                        </div>
                        <!-- End Full Name Field -->
                        <!-- Start Avatar Field -->
...
<?php 
        ...
        <?php 
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                $stmt->execute(array($user, $email, $name, $pass, $id, $avatar));
        ...
        } elseif($do == 'Delete'){ // Delete member button
          ...
          echo "<div class='container'>";
            ...
            if($check > 0){
                ...
                $stmt = $con->prepare("DELETE FROM users WHERE UserID =  :zuser"); //<- UserID= ? OR = :userid OR = :zuser  
