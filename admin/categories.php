                        ...
                        foreach($cats as $cat){
                            echo "<div class='cat'>";
                                ...
                                echo "<div class='full-view'>";
                                    echo "<p><li>"; if($cat['Description'] == ''){ echo 'This Category has no Description';} else { echo $cat['Description']; } echo'</li></p>';
                                ...
                                $child = getAllFrom("*", "categories", "where parent = {$cat['ID']}", "", "ID");
                                if (! empty($child)){
                ...
                <div class="container">
                    <form class="form-horizontal" action="?do=Insert" method="POST">
                        ...
                        <div class="form-group form-group-lg">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="description" class="form-control" placeholder="Describe The Categroy"/>
                            </div>
                        </div>
...
<?php   } elseif ($do == 'Insert'){
            ...
            // Check If Get Request catid Is Numeric & The Integer Value of It
                ...
                <div class="container">
                    <form class="form-horizontal" action="?do=Update" method="POST">
                        ...
                        <div class="form-group form-group-lg">
                            <label class="col-sm-2 control-label">Description</label>
                            <div class="col-sm-10">
                                <input type="text" name="description" class="form-control" placeholder="Describe The Categroy" value="<?php echo $cat['Description'] ?>"/>
                            </div>
                        </div>
                        <!-- End Description Field -->
                        ...
                        <div class="form-group form-group-lg">
                            <label class="col-sm-2 control-label">Ordering</label>
                            <div class="col-sm-10">
                                <input type="text" name="ordering" class="form-control" autocomplete="off" placeholder="Number To Arrange The Categories" value="<?php echo $cat['Ordering'] ?>"/>
                            </div>
                        </div>
                        <!-- End Ordering Field -->
