                                ...
                                foreach($items as $item){
                                    echo"<tr>";
                                        ...
                                        if($item['Approve'] == 0){
                                            ...
                                            echo "<a href='items.php?do=Approve&itemid=" . $item['item_ID'] ."'class='btn btn-info Aprrove'><i class='fa fa-check'></i> Approve</a>";
...
<?php        
            ...
            <div class="container">
                <form class="form-horizontal" action="?do=Insert" method="POST">
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-sm-10">
                            <textarea name="description" class="form-control" autocomplete="off" required="required" placeholder="Describe of Item"></textarea>
                        </div>
                    </div>
 ...
 <?php  } elseif ($do == 'Insert'){
            ...
            // Check If Get Request item Is Numeric & The Integer Value of It
...
<?php
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                $stmt->execute(array($name, $desc, $price, $country, $status, $member, $cat, $stags, $id));
            ...
            echo "<div class='container'>";
              ...
              // Check If Get Request itemid Is Numeric & The Integer Value of It
              ...
              if($check > 0){
                  ...
                  $stmt = $con->prepare("DELETE FROM items WHERE item_ID =  :zid"); //<- item_ID= ? OR = :zid
